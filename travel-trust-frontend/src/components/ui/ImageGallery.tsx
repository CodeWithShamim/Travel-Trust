      ...
      {galleryItems?.map((item, index) => (
        ...
        >
          <Image
            ...
            loading="lazy"
            placeholder="blur"
            blurDataURL={base64EncodedPlaceholder}
          />
