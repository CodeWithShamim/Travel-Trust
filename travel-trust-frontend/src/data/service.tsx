...
export const serviceDetailsLists = (service: IService) => {
  return [
    {
      id: 1,
      icon: <BiSolidTimeFive size={35} color="#FFD20A" />,
      title: 'Duration',
      value: '1 Week',
    },
    {
      id: 2,
      icon: <FaUserAlt size={30} color="#FFD20A" />,
      title: 'Min Age',
      value: '12+',
    },
    {
      id: 3,
      icon: <FaPlane size={30} color="#FFD20A" />,
      title: 'Category',
      value: service?.category ?? 'Any',
    },
    {
      id: 4,
      icon: <IoLocationSharp size={35} color="#FFD20A" />,
      title: 'Location',
